#ifndef __XPL_SWEEPPLUS_H__
#define __XPL_SWEEPPLUS_H__
...
namespace xpl {
  ...
  public:
    inline sweep_plus_node(int lineno,cdk::lvalue_node *left,cdk::expression_node *inicialization,cdk::expression_node *condition,cdk::expression_node *increment,cdk::basic_node *block):
        cdk::basic_node(lineno),_left(left),_inicialization(inicialization), _condition(condition), _increment(increment), _block(block){
    }
    inline sweep_plus_node(int lineno,cdk::lvalue_node *left,cdk::expression_node *inicialization,cdk::expression_node *condition,cdk::basic_node *block):
