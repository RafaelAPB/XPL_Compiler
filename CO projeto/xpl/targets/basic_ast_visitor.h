...
public:
  ...
  virtual void do_variable_definition_node(xpl::variable_definition_node * const node, int lvl) = 0;
  virtual void do_null_node(xpl::null_node * const node, int lvl) = 0;
  virtual void do_memory_position_node(xpl::memory_position_node * const node, int lvl) = 0;
  virtual void do_memory_reservation_node(xpl::memory_reservation_node * const node, int lvl) = 0;
  virtual void do_identity_node(xpl::identity_node * const node, int lvl) = 0;
  virtual void do_indexation_node(xpl::indexation_node * const node, int lvl) = 0;
