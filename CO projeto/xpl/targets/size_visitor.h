#ifndef __XPL_SEMANTICS_SIZE_VISITOR_H__
#define __XPL_SEMANTICS_SIZE_VISITOR_H__
...
public:
  //virtual void do_program_node(xpl::program_node * const node, int lvl) {}
...
public:
  ...
  virtual void do_sweep_plus_node(xpl::sweep_plus_node * const node, int lvl) {}
  virtual void do_sweep_minus_node(xpl::sweep_minus_node * const node, int lvl) {} 
  virtual void do_block_node(xpl::block_node * const node, int lvl) ;
  virtual void do_variable_declaration_node(xpl::variable_declaration_node * const node, int lvl) ;
  virtual void do_variable_definition_node(xpl::variable_definition_node * const node, int lvl) ;
  virtual void do_null_node(xpl::null_node * const node, int lvl) {}
  virtual void do_memory_position_node(xpl::memory_position_node * const node, int lvl) {}
  virtual void do_memory_reservation_node(xpl::memory_reservation_node * const node, int lvl) {}
  virtual void do_identity_node(xpl::identity_node * const node, int lvl) {}
  virtual void do_indexation_node(xpl::indexation_node * const node, int lvl) {}
